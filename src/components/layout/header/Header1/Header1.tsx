...
export default function Header1({
  ...
  return (
    ...
    >
      {/* Desktop Section */}
      {/* Upper Nav  */}
      <Wrapper className="flex w-full items-center justify-between py-2 md:hidden">
        {/* Logo with Link */}
        <Logo />
        <div className="flex items-center gap-2 md:gap-4">
          <button
            className="text-xl duration-300 hover:text-bg1"
      ...
      <Wrapper className="flex w-full items-center justify-between gap-1 py-2 md:hidden">
        ...
        <div className="flex items-center gap-x-2">
          {/* Search Icon  */}
          <button
            className="text-3xl duration-300 hover:text-bg1"
            onClick={handleSearchModal}
          >
            <IoSearchOutline />
          </button>
